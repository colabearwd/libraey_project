...
{
	var oDiv=document.getElementById('comet');
	...
	{
		aLI[i].index=i;
		aLI[i].getElementsByTagName('p')[1].onmousedown=function(){
			openDiv();
		}
		aLI[i].getElementsByTagName('p')[1].onmouseover=function(){
			this.style.backgroundImage='url(images/tXX2.gif)'
		}
		aLI[i].getElementsByTagName('p')[1].onmouseout=function(){
			this.style.backgroundImage='url(images/tXX.gif)'
		}
	}
